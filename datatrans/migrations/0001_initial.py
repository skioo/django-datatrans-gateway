# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-25 09:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='CHF', max_digits=12)),
                ('request_type', models.CharField(blank=True, max_length=3)),
                ('expiry_month', models.IntegerField(blank=True, null=True)),
                ('expiry_year', models.IntegerField(blank=True, null=True)),
                ('expiry_date', models.DateField(blank=True, null=True)),
                ('credit_card_country', models.CharField(blank=True, db_index=True, max_length=3)),
                ('success', models.BooleanField()),
                ('response_code', models.CharField(blank=True, max_length=4)),
                ('response_message', models.CharField(blank=True, max_length=255)),
                ('authorization_code', models.CharField(blank=True, max_length=255)),
                ('acquirer_authorization_code', models.CharField(blank=True, max_length=255)),
                ...
                ('acquirer_error_code', models.CharField(blank=True, max_length=255)),
                ('transaction_id', models.CharField(max_length=18, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acquirer_error_code', models.CharField(blank=True, max_length=255)),
                ('transaction_id', models.CharField(max_length=18, unique=True)),
                ('card_alias', models.CharField(blank=True, db_index=True, max_length=20)),
                ('masked_card_number', models.CharField(blank=True, max_length=255)),
                ('payment_method', models.CharField(blank=True, db_index=True, max_length=3)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_detail', models.CharField(blank=True, max_length=255)),
                ('acquirer_error_code', models.CharField(blank=True, max_length=255)),
                ('transaction_id', models.CharField(blank=True, max_length=18, null=True, unique=True)),
